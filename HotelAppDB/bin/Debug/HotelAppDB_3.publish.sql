...
:setvar DefaultDataPath "C:\Users\Dennis Appiah\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\MSSQLLocalDB\"
:setvar DefaultLogPath "C:\Users\Dennis Appiah\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\MSSQLLocalDB\"
...
begin
	...
	-- when there is no booking done
	-- // select Id, Title, Description, Price from dbo.RoomTypes
	

	-- Available Rooms after a booking
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'c03509a5-aee0-482e-a844-0b621606d5d1')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('c03509a5-aee0-482e-a844-0b621606d5d1')
