...
:setvar DefaultDataPath "C:\Users\denni\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\MSSQLLocalDB\"
:setvar DefaultLogPath "C:\Users\denni\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\MSSQLLocalDB\"
...
begin
    ...
    ('Two Queen Size Bed','A room with two Queen-size bed and a window'),
    ('Executive Suite','Two rooms each with a king size bed')
end
